  ...
  return (
    ...
    <Box sx={{p: 3}} align="left">
      ...
      <Stack direction="row" spacing={2}>
        ...
        <Button variant="contained" startIcon={<Add />}>追加</Button>
        {/* color="warning": 警告用のオレンジ色 */}
        <Button variant="contained" startIcon={<Edit />} color="warning">編集</Button>
        {/* Delete アイコンとエラー色の組み合わせ */}
        <Button variant="contained" startIcon={<Delete />} color="error">編集</Button>
      </Stack>
    </Box>
  );
}
